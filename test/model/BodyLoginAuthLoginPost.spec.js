...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BodyLoginAuthLoginPost', function() {
      beforeEach(function() {
        instance = new Devizzle.BodyLoginAuthLoginPost();
      });

      it('should create an instance of BodyLoginAuthLoginPost', function() {
        // TODO: update the code to test BodyLoginAuthLoginPost
        expect(instance).to.be.a(Devizzle.BodyLoginAuthLoginPost);
      });
